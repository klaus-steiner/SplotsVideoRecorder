package co.splots.recorder.samples;

import co.splots.recorder.samples.util.SystemUiHider;
...
/**
 * An example full-screen activity that shows and hides the system UI (i.e. status bar and navigation/system
 * bar) with user interaction.
 * 
 * @see SystemUiHider
 */
public class SampleRecorderActivity extends Activity {
	 ...
	 * jarring behavior of controls going away while interacting with activity UI.
	 */
