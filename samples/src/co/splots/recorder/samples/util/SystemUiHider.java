package co.splots.recorder.samples.util;
 ...
 * bar. This class uses backward-compatibility techniques described in <a href=
 * "http://developer.android.com/training/backward-compatible-ui/index.html"> Creating Backward-Compatible
 * UIs</a> to ensure that devices running any version of ndroid OS are supported. More specifically, there are
 * separate implementations of this abstract class: for newer devices, {@link #getInstance} will return a
...
public abstract class SystemUiHider {
	 ...
	 * will be set on older devices, making the status bar "float" on top of the activity layout. This is most
	...
	/**
	 * When this flag is set, {@link #show()} and {@link #hide()} will toggle the visibility of the status bar.
	 * If there is a navigation bar, show and hide will toggle low profile mode.
	 */
	public static final int FLAG_FULLSCREEN = 0x2;

	/**
	 * When this flag is set, {@link #show()} and {@link #hide()} will toggle the visibility of the navigation
	 * bar, if it's present on the device and the device allows hiding it. In cases where the navigation bar is
	 * present but cannot be hidden, show and hide will toggle low profile mode.
	 */
	 ...
	 * will be either a {@link SystemUiHiderBase} or {@link SystemUiHiderHoneycomb} depending on the device.
	 * 
	 * @param activity
